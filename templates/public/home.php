                ...
                <?php foreach ($latest_posts as $post): ?>
                    <div class="card">
                        <a href="<?php echo url('/news/' . htmlspecialchars($post['slug'])); ?>">
                            <img src="<?php echo $post['image'] ? SITE_URL . '/uploads/' . htmlspecialchars($post['image']) : SITE_URL . '/assets/img/news-placeholder.jpg'; ?>" alt="<?php echo htmlspecialchars($post['title']); ?>">
                        </a>
